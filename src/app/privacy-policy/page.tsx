    ...
    <div className="bg-background">
      <section className="bg-card py-20 md:py-24">
        <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-headline">Privacy Policy</h1>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl prose prose-lg dark:prose-invert prose-h2:font-headline prose-h2:text-foreground prose-p:text-muted-foreground prose-a:text-primary">
            ...
            <p>
                Welcome to BitEdge Technologies. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
            </p>
            ...
            <h2>7. Contact Us</h2>
            <p>
                If you have questions or comments about this Privacy Policy, please contact us at: <a href="mailto:privacy@bitedgetechnologies.com">privacy@bitedgetechnologies.com</a>.
            </p>
